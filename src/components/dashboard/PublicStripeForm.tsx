...
export default function PublicStripeForm({ onComplete, total, currency }: PublicStripeFormProps) {
    ...
    <div className="space-y-6">
      ...
      {method === "card" ? (
        ...
        <div className="bg-[#0070BA]/5 border-2 border-[#0070BA]/10 rounded-3xl p-8 text-center space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
           ...
           <p className="text-sm font-medium text-[#002169]">Serás redirigido a PayPal para autorizar el cobro de <span className="font-black">{formatMoney(total, currency)}</span> de forma instantánea.</p>
