              ...
              <div className="flex justify-between items-start">
                ...
                {prop.price && (
                  <div className="text-right">
                    <span className="font-extrabold text-lg text-slate-900 block">{formatMoney(prop.price, prop.currency)}</span>
                ...
                <div key={exp.id} className="group relative overflow-hidden rounded-3xl bg-slate-50 border border-slate-100 hover:border-amber-200 hover:shadow-xl transition-all duration-300 cursor-pointer">
                  <div className="p-8 flex flex-col gap-4">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-200 mt-auto">
                      <div>
                        <span className="text-2xl font-extrabold text-slate-900">{formatMoney(exp.price, exp.currency ?? properties[0]?.currency ?? "DOP")}</span>
